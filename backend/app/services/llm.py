...
def _build_trip_plan_prompt(preferences: Dict[str, Any]) -> tuple[str, str]:
    ...
    parts = [
        ...
        "Route reference table (per-person round-trip, economy class):\n",
        "  Intra-East-Asia ≤3h (Seoul/Tokyo/Osaka/Taipei/HK to each other): CAD 200–350. ",
        "  Example confirmed fares: Seoul↔Osaka ~CAD 200–300, Seoul↔Tokyo ~CAD 220–320, Tokyo↔Taipei ~CAD 250–380.\n",
        "  Intra-SE-Asia ≤4h (Bangkok/Singapore/KL/Manila/Bali to each other): CAD 150–350.\n",
        "  Asia cross-regional 4–8h (Korea/Japan↔SE Asia, Japan↔India): CAD 350–800.\n",
        "  Asia↔Oceania 8–10h (Tokyo/Seoul↔Sydney/Auckland): CAD 700–1400.\n",
        "  North America↔East Asia 10–14h (Vancouver/Toronto↔Tokyo/Seoul/Beijing): CAD 900–2200.\n",
        "  North America↔Europe 7–10h: CAD 700–1800.\n",
        "  North America↔SE Asia/South Asia 14h+: CAD 1100–2800.\n",
        "  Intra-Europe (budget carriers): CAD 100–400.\n",
        "  Europe↔Middle East/Africa 4–8h: CAD 400–1100.\n",
        "Set: flight_low_pp = low end of matching range, flight_high_pp = high end.\n",
        ...
        "  ✓ priceEstimate.min/max = per-person values (flight + local), NOT group totals\n",
